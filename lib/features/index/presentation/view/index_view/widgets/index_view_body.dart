...
class IndexViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocBuilder<GetTasksByDayCubit, GetTaskByDayState>(
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: CustomDropDown(
            selectedValue:
                BlocProvider.of<GetTasksByDayCubit>(context).sortedDate!.day ==
                    DateTime.now().day
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) => BlocProvider(
                create: (context) =>
                    ChangeTaskStatusCubit(getIt.get<ChangeTaskStatusUseCase>()),
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.h),
                  child: TaskItem(task: state.uncompleted[index]),
                ),
              ),
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) => Padding(
                ...
                child: BlocProvider(
                  ...
                  child: TaskItem(task: state.completed[index]),
                ),
              ),
